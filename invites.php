...
<body>
	<div id="navbar" class="topnav">
		<a onclick="home()">
			<h2 class="title">WCE Event Scheduler</h2>
		</a>
	</div>
	<div class="sidenav" id="sidenavId">
		...
		<a class="sidenavlinks" onclick="window.location.href='appointmentdisplay.php'">Events</a>

	</div>
	<div class="main"><?php echo $_SESSION['message'] ?>
	</div>
	<div class="main inviteTitle">
		<h2>Invite Notifications</h2>
	</div>
